...
class SolvingFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        ctk.CTkEntry(self, textvariable=self.options["res"], width=100).grid(
            row=0, column=1
        )
        ...
        self.vf_entry = ctk.CTkEntry(self, textvariable=self.options["vf_value"], width=100)
        ...
        ctk.CTkEntry(self, textvariable=self.options["log_name"], width=100).grid(row=4, column=1, sticky="w")
